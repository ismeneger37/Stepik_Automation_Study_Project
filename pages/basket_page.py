...
class BasketPage(BasePage):
    ...
    def should_be_message_basket_is_empty(self):
        message_basket_is_empty = self.browser.find_element(*BasketPageLocators.BASKET_IS_EMPTY_TEXT).text
        assert message_basket_is_empty in "Ваша корзина пуста", "No product in basket"
